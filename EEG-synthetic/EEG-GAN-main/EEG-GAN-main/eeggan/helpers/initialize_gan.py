...
gan_architectures = {
    'TTSGenerator': lambda seq_len, hidden_dim, patch_size, channels, latent_dim, num_layers, num_heads, **kwargs: 
        TTSGenerator(
            seq_len=seq_len, 
            ...
            depth=num_layers, 
            num_heads=num_heads, # Prende quello passato da init_gan
            forward_drop_rate=0.5, 
            attn_drop_rate=0.5
        ),
    'TTSDiscriminator': lambda channels, hidden_dim, patch_size, seq_len, num_layers, num_heads, **kwargs: 
        TTSDiscriminator(
