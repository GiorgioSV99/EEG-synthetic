...
from .lae_training_main import main as lae_training_main
from .generate_samples_lae_main import main as generate_samples_lae_main
...
def main():
    ...
    elif command.lower() == 'generate_samples_lae':
        generate_samples_lae_main(args)
    elif command.lower() == 'visualize':
        visualize_main(args)
    elif command.lower() == 'setup_tutorial':
        setup_tutorial_main()
    elif command.lower() == 'lae_training':
        # Assicurati di aver importato la tua funzione in alto nel file: 
        # from eeggan.lae_training_main import main as lae_main
        lae_training_main(args)
    else:
